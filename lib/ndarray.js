...
var sindexOfTruthy = require( '@stdlib/blas-ext-base-sindex-of-truthy' ).ndarray;
...
*
* var idx = slastIndexOfTruthy( x.length, x, 1, 0 );
* // returns 7
*/
function slastIndexOfTruthy( N, x, strideX, offsetX ) {
	var idx;
	...
	// Find the index of the first truthy element in the reversed "view":
	idx = sindexOfTruthy( N, x, strideX, offsetX );
	if ( idx < 0 ) {
		return idx;
	}
